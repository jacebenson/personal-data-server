...
class UsersController < ApplicationController
  ...
  def show
    ...
    @available_accounts = current_user.bank_statements.distinct.pluck(:account).compact.sort
  end
  ...
  def user_params
    params.require(:user).permit(:setting_privacy_mode, :timezone, :investment_goal, :discretionary_account, :investment_breakdown, :weight_goal, :weight_breakdown)
  end
end
