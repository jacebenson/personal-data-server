...
ActiveRecord::Schema[8.0].define(version: 2025_08_23_142353) do
...
# Could not dump table "contacts_backup" because of following StandardError
#   Unknown type 'NUM' for column 'birthday'
  ...
  create_table "linkedin_imports", force: :cascade do |t|
    t.integer "user_id", null: false
    t.string "file_path", null: false
    t.string "original_filename"
    t.integer "total_contacts", default: 0
    t.integer "contacts_imported", default: 0
  ...
  create_table "mbox_imports", force: :cascade do |t|
    t.integer "user_id", null: false
    t.string "file_path", null: false
    t.string "original_filename"
    t.integer "total_emails", default: 0
    t.integer "contacts_extracted", default: 0
    t.integer "status", default: 0
    t.text "error_message"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.boolean "setting_privacy_mode", default: false, null: false
  ...
  add_foreign_key "linkedin_imports", "users"
  add_foreign_key "mbox_imports", "users"
  ...
  add_foreign_key "vcard_imports", "users"
end
